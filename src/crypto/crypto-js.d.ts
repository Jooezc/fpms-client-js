  ...
  namespace CryptoJS {
    ...
    export namespace lib {
      ...
      const SerializableCipher: {
         ...
         */
        encrypt(cipher: CipherStatic, message: WordArray | string, key: WordArray, cfg?: CipherOption): CipherParams;
         ...
         */
        decrypt(cipher: CipherStatic, ciphertext: WordArray | string, key: WordArray, cfg?: CipherOption): CipherParams;
      ...
      const PasswordBasedCipher: {
         ...
         */
        encrypt(cipher: CipherStatic, message: WordArray | string, password: string, cfg?: CipherOption): CipherParams;
