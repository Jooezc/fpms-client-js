...
class FpmsService {
    ...
    closeWsClient() {
        if (__classPrivateFieldGet(this, _FpmsService_socket, "f") &&
            (__classPrivateFieldGet(this, _FpmsService_socket, "f").readyState === WebSocket.OPEN ||
                __classPrivateFieldGet(this, _FpmsService_socket, "f").readyState === WebSocket.CONNECTING))
...
_FpmsService_requestId = new WeakMap(), _FpmsService_callbackMap = new WeakMap(), _FpmsService_wsErrorHandler = new WeakMap(), _FpmsService_mdSalt = new WeakMap(), _FpmsService_socket = new WeakMap(), _FpmsService_config = new WeakMap(), _FpmsService_aliveInterval = new WeakMap(), _FpmsService_isLogin = new WeakMap(), _FpmsService_isDebug = new WeakMap(), _FpmsService_instances = new WeakSet(), _FpmsService_getWsUrl = function _FpmsService_getWsUrl() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getSocket = new Promise((resolve, reject) => {
            if (__classPrivateFieldGet(self, _FpmsService_socket, "f") == undefined) {
                ...
                if (__classPrivateFieldGet(self, _FpmsService_socket, "f").readyState === WebSocket.CONNECTING) {
                ...
                if (__classPrivateFieldGet(self, _FpmsService_socket, "f").readyState === WebSocket.CLOSING ||
                    __classPrivateFieldGet(self, _FpmsService_socket, "f").readyState === WebSocket.CLOSED) {
    ...
    if (!__classPrivateFieldGet(this, _FpmsService_socket, "f"))
        return false;
    return __classPrivateFieldGet(this, _FpmsService_socket, "f") && __classPrivateFieldGet(this, _FpmsService_socket, "f").readyState === WebSocket.OPEN;
    ...
    try {
        ...
        const key = CryptoJS.MD5(__classPrivateFieldGet(this, _FpmsService_mdSalt, "f")).toString(CryptoJS.enc.Hex);
        const retStr = CryptoJS.enc.Base64.stringify(CryptoJS.HmacSHA256(txtStr, key));
